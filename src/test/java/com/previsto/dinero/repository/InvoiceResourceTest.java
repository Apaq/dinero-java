...
public class InvoiceResourceTest extends ResourceTestBase<Invoice> {
    ...
    protected String generateExpectedGetQueryParams() {
        return "?page=1&pageSize=1000&fields=Number,Guid,ContactName,Date,PaymentDate,Description,Currency,Status,MailOutStatus,TotalExclVatInDkk,TotalInclVatInDkk,TotalExclVat,TotalInclVat,CreatedAt,UpdatedAt,DeletedAt";
    }
